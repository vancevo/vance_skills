...
* **[`/back_end`](./back_end)**: Định hình chuẩn mực cho mảng máy chủ (Backend), cung cấp quy tắc xử lý Database, bảo mật API và các định hướng cốt lõi theo hệ sinh thái Node.js / NestJS / Express.js.
